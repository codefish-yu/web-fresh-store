# -*- coding: utf-8 -*-
# Generated by Django 1.11.8 on 2020-01-24 13:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(choices=[(1, '货到支付'), (2, '微信支付'), (3, '支付宝'), (4, '银联支付')], default=3, verbose_name='支付方式')),
                ...
                ('order_status', models.SmallIntegerField(choices=[(1, '待支付'), (2, '待支付'), (3, '待收据'), (4, '待评价'), (5, '已完成')], default=1, verbose_name='订单状态')),
